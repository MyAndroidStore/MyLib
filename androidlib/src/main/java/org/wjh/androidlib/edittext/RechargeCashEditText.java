 ...
 * 现金输入的editText
 */
public class RechargeCashEditText extends android.support.v7.widget.AppCompatEditText {


    public RechargeCashEditText(Context context) {
        super(context);
        noClick();
        setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL);
    }

    public RechargeCashEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        noClick();
        setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL);
    }

    public RechargeCashEditText(Context context, AttributeSet attrs, int defStyleAttr) {
